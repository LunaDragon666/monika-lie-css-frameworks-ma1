...
### Main
In the main content of this page, which is in this case `gridbox__container` I used CSS Grid instead of flexbox to layout a group of square «boxes» inside the grid-layout.
### Footer
